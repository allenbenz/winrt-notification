...
mod internal {
    ...
    pub unsafe fn RtlGetNtVersionNumbers(major: *mut u32, minor: *mut u32, build: *mut u32) {
        ...
        if let Some(RtlGetNtVersionNumbers_FUNCTION) = CacheRtlGetNtVersionNumbers {
            ...
            // RtlGetNtVersionNumbers should be present even in very old version of windows.
            // Assume something else has gone wrong and guess we are using newer than windows 8.1
            //major = 7;
            panic!("test panic")
        }
    }
